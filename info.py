...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001511251154').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Orangepeel:applelayer@cluster0.0wwtjws.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+sJOCf7vp4sdhM2Vl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Fxa4IrH6obY4MWFl')
...
URL = "https://marxist-stephani-vasudhfm.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://marxist-stephani-vasudhfm.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://marxist-stephani-vasudhfm.koyeb.app/".format(FQDN)
else:
    URL = "https://marxist-stephani-vasudhfm.koyeb.app/".format(FQDN)
